...
#ifdef ANDROID
static int android_log_level = ANDROID_LOG_UNKNOWN;
static int flags;
#endif
...
void av_log_callback_android(void* ptr, int level, const char* fmt, va_list vl)
{
#ifdef LOG
    static int print_prefix = 1;
    static int count;
